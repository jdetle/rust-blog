...
export default async function WhoAreYouPage() {
  ...
  const edgeInfo = {
    pop: hdrs.get("x-edge-pop") ?? hdrs.get("x-vercel-id")?.split("::")[0] ?? null,
    ...
    <main className="site-shell">
      <div className="frame article">
        <header className="list-header">
          ...
          <p className="byline">
            Everything below was gathered by your browser and my edge servers
        ...
        <article className="article-content">
          ...
          <p>
            ...
            cross-references it with your browser&apos;s timezone, language,
            and WebRTC signals to determine whether your connection is a
            genuine household IP or being routed through a VPN, proxy, or
            datacenter.
          </p>
