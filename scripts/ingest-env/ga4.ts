...
const value = process.argv[2] ?? (await prompt("Paste your GA4 Measurement ID (G-XXXXXXXXXX): "));
if (!value?.trim()) {
  console.error("No value provided. Usage: bun run scripts/ingest-env/ga4.ts [G-XXXXXXXXXX]");
  process.exit(1);
}
